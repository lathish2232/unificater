...
# SQL server connection
            ...
            connection = pyodbc.connect(host=host,user=user, password =password,database =db_name,port=port,Driver='ODBC Driver 13 for SQL Server',Trusted_connection='yes')
#sql Lite
        elif server == 5:
